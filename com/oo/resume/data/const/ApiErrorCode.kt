package com.oo.resume.data.const

/**
 *  $author yangchao
 *  $email  cd.uestc.superyoung@gmail.com
 *  $date   2019-07-22 10:16
 *  $describe
 */
interface ApiErrorCode {
    ...
    companion object {
        ...
        const val SOCKET_TIMEOUT = 408//服务器等候请求时发生超时
        const val NETWORK_UNREACHABLE = 602//网络不可用
        const val UNKNOW = 999//未知错误
    }
